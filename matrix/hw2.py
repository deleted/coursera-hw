...
def GF2_span(D, L):
    ...
    if len(L) == 0:
        return [Vec(D, {})]
    if len(L) == 1:
        return [one * L[0], 0 * L[0]]
    else:
        span = []
        for v1 in GF2_span(D, [L[0]]):
            for v2 in GF2_span(D, L[1:]):
                span.append(vec_sum( [v1,v2], D ))
        return list(span)
...
is_it_a_vector_space_1 = None
is_it_a_vector_space_2 = None



## Problem 5
is_it_a_vector_space_3 = None
is_it_a_vector_space_4 = None


## Problem 6

is_it_a_vector_space_5 = None
is_it_a_vector_space_6 = None
